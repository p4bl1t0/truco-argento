...
\begin{figure}
%\begin{center}
\noindent \makebox[\textwidth] {\includegraphics[width=\linewidth]{truco1.png}}
\caption{Comienzo del juego.}
%\end{center}
\end{figure}

\begin{figure}
\noindent \makebox[\textwidth]{\includegraphics[width=\linewidth]{envido1.png}}
\caption{El programa canta envido.}
\end{figure}

\begin{figure}
\noindent \makebox[\textwidth]{\includegraphics[width=\linewidth]{envido2.png}}
\caption {El humano canta envido y el programa acepta.}
\end{figure}

\begin{figure}
\noindent \makebox[\textwidth]{\includegraphics[width=\linewidth]{retruco.png}}
